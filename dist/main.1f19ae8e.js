...
var div1 = dom.create('<div>bye</div>');
var div2 = dom.create('<div>pop</div>');
var div3 = dom.create('<div>wrapper</div>');
console.log(div);
dom.after(test, div1);
dom.before(test, div);
...
var wrapperDiv = dom.find('div')[0];
dom.each(dom.children(wrapperDiv), function (node) {
  return dom.style(node, 'color', 'cyan');
});
console.log('---index:---');
